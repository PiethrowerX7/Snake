...
# Credit goes to "Clear Code" on YouTube for helping me learn pygame better and to help me understand various concepts better, link to the video here: https://youtu.be/QFvqStqPCRU?si=4Hq1W5pxAyxykcLM
...
class MAIN:
    ...
    def draw_score(self):
        ...
        bg_rect = pygame.Rect(apple_rect.left,apple_rect.top,apple_rect.width + score_rect.width + 5,apple_rect.height + 5)
...
# Objects
main_game = MAIN()
game_font = pygame.font.Font('Fonts/blue_style/Blue Style.ttf',25)
...
# CODE BELOW CAN BE DELETED IF YOU WISH
